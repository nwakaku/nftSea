...
const item = (img, title, text) => {
  return (
    <div style={{width: "22%", height: "350px", textAlign: "center", borderRadius: "5px", margin: "0 5px", padding: "10px 32px", fontFamily: "VT323", border: "1px solid black"}}>
      <img 
        width={48}
        src={img}
        alt="Image"
      ...
      <div style={{color: "#606060"}}><p>{text}</p></div>
    </div>
  )
}
      ...
      <Grid  sx={{width: "80%", display: "flex", flexDirection:"column", justifyContent: "flex-start", paddingTop: 0}}>
        <div style={{display: "inline-flex", alignItems: "center"}}>
          <div style={{width: "50%", padding: "0px 48px"}}>
            <h1 style={{fontSize: 50, fontWeight: 700, marginBottom: 32, lineHeight: 1.2, fontFamily: "VT323"}}>Explore, collect, and sell extraordinary NFTs</h1>
            ...
            <CustomButton
              ...
              sx={{padding: "8px 48px"}}
              style={{backgroundColor: "#E44D2E", color: "white"}}
              component={Link}
              to="/explore"
            >
            Explore
          ...
          <div style={{width: "50%", paddingLeft: 48}}>
            <img 
              width={500}
              src={"https://i.seadn.io/gae/P1WOzkGqp_mU_1jvpFhQnevYKryg0BZbzmuiawx-Xm-5NtuvhWXXPQu5P0llghCzAinhL6iOS8M0wmBLS_naA4d1jsyBTYyXP47br6U?auto=format&w=2048"}
        ...
        <div style={{paddingTop: 144}}>
          <div style={{display: "flex", justifyContent:"center"}}>
            <h2 style={{fontWeight: 700, marginBottom: 64, fontFamily: "VT323", fontSize: 35}}>Create and sell your NFTs</h2>
          </div>
        ...
        <div style={{paddingTop: 144}}>
          <div style={{flex:1, display: "flex", flexDirection:"column", justifyContent:"center", alignItems:"center", marginBottom: 48}}>
            <h2 style={{fontWeight: 700,fontSize: 40,fontFamily: "VT323"}}>Blockchain Ecosystems and Softwares</h2>
