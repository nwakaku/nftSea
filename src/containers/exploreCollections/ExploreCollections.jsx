     ...
     <Grid container sx={{display: "flex", flexDirection:"column", alignItems: "center", padding: 3}}>
      <Grid  sx={{width: "70%", display: "flex", flexDirection:"column", justifyContent: "flex-start", paddingTop: 0}}>
        ...
        <Tabs value={tabValue} onChange={handleTabChange} >
          <Tab label="All Listed Items" sx={{fontSize: "20px", textTransform: "None", fontFamily: "VT323", fontWeight: 900}}/>
          <Tab label="My Listed Items " sx={{fontSize: "20px", textTransform: "None", fontFamily: "VT323", fontWeight: 900}}/>
          <Tab label="My Purchased Items" sx={{fontSize: "20px", textTransform: "None", fontFamily: "VT323", fontWeight: 900}}/>
        </Tabs>
